...
// `TOPROCESS` + `id` will be used to read msg from sch
...
int main(int argc , char * argv[])
{
	...
	printf("[SCHEDULER] : Number of Process = %d\n", k);
	...
	while (1)
	{
		...
		{
			printf("[SCHEDULER - Proecss %d] : Pagefault handled\n", curr_id);
		...
		{
			perror("[SCHEDULER - MMU]: INVALID MESSAGE\n");
			exit(1);
		}
